    ...
    <body>
        <div id="wrap">
            <div class="leftMeun" id="leftMeun">
                ...
                <div class="meun-item meun-item-active" aria-controls="stud" role="tab" data-toggle="tab"><a href="/admin/mess"><img src="/public/images/icon_card_grey.png">留言信息</div></a>
            </div>
            <div id="rightContent">
                            ...
                            <div class="data-div">
                                ...
                                @if (!empty($result3))
                                    ...
                                    <div class="row">
                                        ...
                                        <form action="/admin/delmess" method="post">
                                        {{csrf_field()}}
