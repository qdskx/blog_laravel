    ...
    <body>
        <div id="wrap">
            <div class="leftMeun" id="leftMeun">
                ...
                <div class="meun-item meun-item-active" aria-controls="char" role="tab" data-toggle="tab"><a href="/admin/rev"><img src="/public/images/icon_source_grey.png">回复管理</div></a>
                            ...
                            <div class="data-div">
                                ...
                                @if (!empty($result2))
                                    ...
                                    <div class="row">
                                        ...
                                        <form action="/admin/delrev" method="post">
                                        {{csrf_field()}}
